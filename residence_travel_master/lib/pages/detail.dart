...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 127, 211, 230),
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 155, 228, 239),
        elevation: 0,
      ...
      bottomNavigationBar: Container(
        height: 100,
        decoration: BoxDecoration(
            color: Color.fromARGB(255, 235, 242, 244),
            boxShadow: [
              BoxShadow(
                  offset: Offset.zero,
                  color: black.withOpacity(0.5),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text.rich(TextSpan(children: [
                        TextSpan(
                            text: '${widget.destination.price}\k',
                            style: const TextStyle(
                                color: blue,
                                fontSize: 20,
